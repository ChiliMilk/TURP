...
namespace UnityEditor.Rendering.Universal.ShaderGraph
{
    sealed class UniversalLitSubTarget : UniversalSubTarget, ILegacyTarget
    {
        ...
        public override void GetActiveBlocks(ref TargetActiveBlockContext context)
        {
            ...
            //ToonShading
            context.AddBlock(BlockFields.SurfaceDescription.ToonDiffuseRampV);
            context.AddBlock(BlockFields.SurfaceDescription.ToonSpecularFeather);
        }
        ...
        public bool TryUpgradeFromMasterNode(IMasterNode1 masterNode, out Dictionary<BlockFieldDescriptor, int> blockMap)
        {
            ...
            blockMap = new Dictionary<BlockFieldDescriptor, int>()
            {
                ...
                //ToonShading
                { BlockFields.SurfaceDescription.ToonDiffuseRampV, 12 },
                { BlockFields.SurfaceDescription.ToonSpecularFeather, 13 },
            };
        ...
        static class LitBlockMasks
        {
            public static readonly BlockFieldDescriptor[] FragmentLit = new BlockFieldDescriptor[]
            {
                ...
                //ToonShading
                BlockFields.SurfaceDescription.ToonDiffuseRampV,
                BlockFields.SurfaceDescription.ToonSpecularFeather
            };
        ...
        static class LitIncludes
        {
            ...
            //ToonShading
            const string kToonData = "Packages/com.unity.render-pipelines.universal/ShaderLibrary/SurfaceData.hlsl";
            ...
            public static readonly IncludeCollection Forward = new IncludeCollection
            {
                ...
                {kToonData,  IncludeLocation.Postgraph}
            };
