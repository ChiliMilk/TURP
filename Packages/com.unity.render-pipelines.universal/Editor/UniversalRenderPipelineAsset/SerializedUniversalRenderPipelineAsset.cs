...
namespace UnityEditor.Rendering.Universal
{
    internal class SerializedUniversalRenderPipelineAsset
    {
        ...
        //ToonShading
        public SerializedProperty toonRimWidthProp { get; }
        public SerializedProperty toonRimThresholdProp { get; }
        public SerializedProperty toonRimIntensityProp { get; }
        public SerializedProperty toonRimMaxDistanceProp { get; }
        public SerializedProperty toonDepthShadowOffsetProp { get; }
        public SerializedProperty toonDepthShadowThresholdProp { get; }
        public SerializedProperty toonDepthShadowMaxDistanceProp { get; }
        ...
        public SerializedUniversalRenderPipelineAsset(SerializedObject serializedObject)
        {
            ...
            //ToonShading
            toonRimWidthProp = serializedObject.FindProperty("m_ToonRimWidth");
            toonRimThresholdProp = serializedObject.FindProperty("m_ToonRimThreshold");
            toonRimIntensityProp = serializedObject.FindProperty("m_ToonRimIntensity");
            toonRimMaxDistanceProp = serializedObject.FindProperty("m_ToonRimMaxDistance");
            toonDepthShadowOffsetProp = serializedObject.FindProperty("m_ToonDepthShadowOffset");
            toonDepthShadowThresholdProp = serializedObject.FindProperty("m_ToonDepthShadowThreshold");
            toonDepthShadowMaxDistanceProp = serializedObject.FindProperty("m_ToonDepthShadowMaxDistance");
