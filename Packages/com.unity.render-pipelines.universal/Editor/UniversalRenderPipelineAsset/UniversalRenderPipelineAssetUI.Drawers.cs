...
namespace UnityEditor.Rendering.Universal
{
    ...
    internal partial class UniversalRenderPipelineAssetUI
    {
        ...
        static void DrawLighting(SerializedUniversalRenderPipelineAsset serialized, Editor ownerEditor)
        {
            ...
            // ToonShading
            EditorGUILayout.LabelField(Styles.toonRimText);
            EditorGUI.indentLevel++;
            EditorGUILayout.PropertyField(serialized.toonRimWidthProp, Styles.toonRimWidthText);
            EditorGUILayout.PropertyField(serialized.toonRimThresholdProp, Styles.toonRimThresholdText);
            EditorGUILayout.PropertyField(serialized.toonRimIntensityProp, Styles.toonRimIntensityText);
            EditorGUILayout.PropertyField(serialized.toonRimMaxDistanceProp, Styles.toonRimMaxDistanceText);
            EditorGUI.indentLevel--;

            EditorGUILayout.LabelField(Styles.toonDepthShadowText);
            EditorGUI.indentLevel++;
            EditorGUILayout.PropertyField(serialized.toonDepthShadowOffsetProp, Styles.toonDepthShadowOffsetText);
            EditorGUILayout.PropertyField(serialized.toonDepthShadowThresholdProp, Styles.toonDepthShadowThresholdText);
            EditorGUILayout.PropertyField(serialized.toonDepthShadowMaxDistanceProp, Styles.toonDepthShadowMaxDistanceText);
            EditorGUI.indentLevel--;
        }
