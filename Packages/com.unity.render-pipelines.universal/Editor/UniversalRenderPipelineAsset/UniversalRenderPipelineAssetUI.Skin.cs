...
namespace UnityEditor.Rendering.Universal
{
    internal partial class UniversalRenderPipelineAssetUI
    {
        internal static class Styles
        {
            ...
            //ToonShading
            public static GUIContent toonRimText = EditorGUIUtility.TrTextContent("Toon Rim");
            public static GUIContent toonRimWidthText = EditorGUIUtility.TrTextContent("Toon RimWidth");
            public static GUIContent toonRimThresholdText = EditorGUIUtility.TrTextContent("Toon RimThreshold");
            public static GUIContent toonRimIntensityText = EditorGUIUtility.TrTextContent("Toon RimIntensity");
            public static GUIContent toonRimMaxDistanceText = EditorGUIUtility.TrTextContent("Toon RimMaxDistance");
            public static GUIContent toonDepthShadowText = EditorGUIUtility.TrTextContent("Toon DepthShadow");
            public static GUIContent toonDepthShadowOffsetText = EditorGUIUtility.TrTextContent("Toon DepthShadow Offset");
            public static GUIContent toonDepthShadowThresholdText = EditorGUIUtility.TrTextContent("Toon DepthShadow Threshold");
            public static GUIContent toonDepthShadowMaxDistanceText = EditorGUIUtility.TrTextContent("Toon DepthShadow MaxDistance");
