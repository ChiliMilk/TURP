...
namespace UnityEngine.Rendering.Universal
{
    ...
    public partial class UniversalRenderPipelineAsset : RenderPipelineAsset, ISerializationCallbackReceiver
    {
        ...
        //ToonShading
        [SerializeField] float m_ToonRimWidth = 10.0f;
        [SerializeField] float m_ToonRimThreshold = 1.0f;
        [SerializeField] float m_ToonRimMaxDistance = 10.0f;
        [SerializeField] float m_ToonRimIntensity = 0.5f;
        [SerializeField] float m_ToonDepthShadowOffset = 10.0f;
        [SerializeField] float m_ToonDepthShadowThreshold = 0.3f;
        [SerializeField] float m_ToonDepthShadowMaxDistance = 100f;
        ...
        //ToonShading
        public float toonRimWidth
        {
            get { return m_ToonRimWidth; }
            set { m_ToonRimWidth = Mathf.Max(0.0f, value); }
        }

        public float toonRimThreshold
        {
            get { return m_ToonRimThreshold; }
            set { m_ToonRimThreshold = Mathf.Max(0.0f, value); }
        }

        public float toonRimIntensity
        {
            get { return m_ToonRimIntensity; }
            set { m_ToonRimIntensity = Mathf.Max(0.0f, value); }
        }

        public float toonRimMaxDistance
        {
            get { return m_ToonRimMaxDistance; }
            set { m_ToonRimMaxDistance = Mathf.Max(0.0f, value); }
        }

        public float toonDepthShadowOffset
        {
            get { return m_ToonDepthShadowOffset; }
            set { m_ToonDepthShadowOffset = Mathf.Max(0.0f, value); }
        }

        public float toonDepthShadowThreshold
        {
            get { return m_ToonDepthShadowThreshold; }
            set { m_ToonDepthShadowThreshold = Mathf.Max(0.0f, value); }
        }

        public float toonDepthShadowMaxDistance
        {
            get { return m_ToonDepthShadowMaxDistance; }
            set { m_ToonDepthShadowMaxDistance = Mathf.Max(0.0f, value); }
        }
...
#pragma warning restore 618 // Obsolete warning
        ...
        public sealed class TextureResources
        {
            ...
            //ToonShading
            [Reload("Textures/Toon/ToonDiffuseRamp.png")]
            public Texture2D toonDiffuseRampTex;
            ...
            {
                return blueNoise64LTex == null || bayerMatrixTex == null || toonDiffuseRampTex == null;
            }
        }
    }
}
