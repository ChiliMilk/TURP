    ...
    internal class DeferredLights
    {
        ...
        void RenderStencilDirectionalLights(CommandBuffer cmd, ref RenderingData renderingData, NativeArray<VisibleLight> visibleLights, int mainLightIndex)
        {
            ...
            for (int soffset = m_stencilVisLightOffsets[(int)LightType.Directional]; soffset < m_stencilVisLights.Length; ++soffset)
            {
                ...
                //ToonShading
                cmd.SetGlobalFloat(ShaderConstants._ToonRimWidth, renderingData.lightData.toonRimWidth);
                cmd.SetGlobalFloat(ShaderConstants._ToonRimThreshold, renderingData.lightData.toonRimThreshold);
                cmd.SetGlobalFloat(ShaderConstants._ToonRimIntensity, renderingData.lightData.toonRimIntensity);
                cmd.SetGlobalFloat(ShaderConstants._ToonRimMaxDistance, renderingData.lightData.toonRimMaxDistance);
                cmd.SetGlobalFloat(ShaderConstants._ToonDepthShadowOffset, renderingData.lightData.toonDepthShadowOffset);
                cmd.SetGlobalFloat(ShaderConstants._ToonDepthShadowThreshold, renderingData.lightData.toonDepthShadowThreshold);
                cmd.SetGlobalFloat(ShaderConstants._ToonDepthShadowMaxDistance, renderingData.lightData.toonDepthShadowMaxDistance);
