...
namespace UnityEngine.Rendering.Universal.Internal
{
    ...
    public class ForwardLights
    {
        static class LightConstantBuffer
        {
            ...
            //ToonShading
            public static int _ToonRimWidth = Shader.PropertyToID("_ToonRimWidth");
            public static int _ToonRimThreshold = Shader.PropertyToID("_ToonRimThreshold");
            public static int _ToonRimIntensity = Shader.PropertyToID("_ToonRimIntensity");
            public static int _ToonRimMaxDistance = Shader.PropertyToID("_ToonRimMaxDistance");
            public static int _ToonDepthShadowOffset = Shader.PropertyToID("_ToonDepthShadowOffset");
            public static int _ToonDepthShadowThreshold = Shader.PropertyToID("_ToonDepthShadowThreshold");
            public static int _ToonDepthShadowMaxDistance = Shader.PropertyToID("_ToonDepthShadowMaxDistance");
        }
        ...
        void SetupShaderLightConstants(CommandBuffer cmd, ref RenderingData renderingData)
        {
            ...
            SetupToonLightConstants(cmd, ref renderingData);
        }
        ...
        void SetupToonLightConstants(CommandBuffer cmd, ref RenderingData renderingData)
        {
            //ToonShading
            cmd.SetGlobalFloat(LightConstantBuffer._ToonRimWidth, renderingData.lightData.toonRimWidth);
            cmd.SetGlobalFloat(LightConstantBuffer._ToonRimThreshold, renderingData.lightData.toonRimThreshold);
            cmd.SetGlobalFloat(LightConstantBuffer._ToonRimIntensity, renderingData.lightData.toonRimIntensity);
            cmd.SetGlobalFloat(LightConstantBuffer._ToonRimMaxDistance, renderingData.lightData.toonRimMaxDistance);
            cmd.SetGlobalFloat(LightConstantBuffer._ToonDepthShadowOffset, renderingData.lightData.toonDepthShadowOffset);
            cmd.SetGlobalFloat(LightConstantBuffer._ToonDepthShadowThreshold, renderingData.lightData.toonDepthShadowThreshold);
            cmd.SetGlobalFloat(LightConstantBuffer._ToonDepthShadowMaxDistance, renderingData.lightData.toonDepthShadowMaxDistance);
        }
