...
#pragma warning restore 0618
        ...
        static void InitializeLightData(UniversalRenderPipelineAsset settings, NativeArray<VisibleLight> visibleLights, int mainLightIndex, out LightData lightData)
        {
            ...
            //ToonShading
            lightData.toonRimWidth = settings.toonRimWidth;
            lightData.toonRimThreshold = settings.toonRimThreshold;
            lightData.toonRimIntensity = settings.toonRimIntensity;
            lightData.toonRimMaxDistance = settings.toonRimMaxDistance;
            lightData.toonDepthShadowOffset = settings.toonDepthShadowOffset;
            lightData.toonDepthShadowThreshold = settings.toonDepthShadowThreshold;
            lightData.toonDepthShadowMaxDistance = settings.toonDepthShadowMaxDistance;
        }
        ...
        static void SetupPerFrameShaderConstants()
        {
            ...
            //ToonShading
            Shader.SetGlobalTexture(Shader.PropertyToID("_ToonDiffuseRamp"), asset.textures.toonDiffuseRampTex);
        }
