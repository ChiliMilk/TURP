...
half MainLightRealtimeShadowPoint(float3 positionWS)
{
    ...
    real attenuation;
    real shadowStrength = shadowParams.x;
    attenuation = real(SAMPLE_TEXTURE2D_SHADOW(_MainLightShadowmapTexture, sampler_MainLightShadowmapTexture, shadowCoord.xyz));
    attenuation = LerpWhiteTo(attenuation, shadowStrength);
