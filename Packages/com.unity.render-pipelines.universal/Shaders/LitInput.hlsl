...
UNITY_DOTS_INSTANCING_START(MaterialPropertyMetadata)
    ...
    UNITY_DOTS_INSTANCED_PROP(float, _ToonSpecularFeather)
...
#define _ToonSpecularFeather           UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float  , _ToonSpecularFeather)
...
ToonData InitializeToonData()
{
    ToonData outToonData = (ToonData)0;
    outToonData.toonDiffuseRampV = _ToonDiffuseRampV;
    outToonData.toonSpecularFeather = _ToonSpecularFeather;
