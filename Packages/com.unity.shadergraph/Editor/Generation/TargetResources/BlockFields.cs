...
namespace UnityEditor.ShaderGraph
{
    internal static class BlockFields
    {
        ...
        public struct SurfaceDescription
        {
            ...
            //ToonShading
            public static BlockFieldDescriptor ToonDiffuseRampV = new BlockFieldDescriptor(SurfaceDescription.name, "ToonDiffuseRampV", null,
                new FloatControl(0.0f), ShaderStage.Fragment);

            public static BlockFieldDescriptor ToonSpecularFeather = new BlockFieldDescriptor(SurfaceDescription.name, "ToonSpecularFeather", null,
                new FloatControl(0.0f), ShaderStage.Fragment);
        }
